...
let s:N2 = [ "{color12}", "{color8}", 'NONE', 'NONE', 'NONE' ]
let s:N3 = [ "{color12}", "{color0}", 'NONE', 'NONE', 'NONE' ]

" Insert mode
let s:I  = [ "{color0}", "{color10}", 'NONE', 'NONE', 'BOLD' ]
let s:I2 = [ "{color10}", "{color8}", 'NONE', 'NONE', 'NONE' ]
let s:I3 = [ "{color10}", "{color0}", 'NONE', 'NONE', 'NONE' ]

" Visual mode
let s:V  = [ "{color0}", "{color9}", 'NONE', 'NONE', 'BOLD' ]
let s:V2 = [ "{color9}", "{color8}", 'NONE', 'NONE', 'NONE' ]
let s:V3 = [ "{color9}", "{color0}", 'NONE', 'NONE', 'NONE' ]

" Replace mode
let s:R  = [ "{color0}", "{color13}", 'NONE', 'NONE', 'BOLD' ]
let s:R2 = [ "{color13}", "{color8}", 'NONE', 'NONE', 'NONE' ]
let s:R3 = [ "{color13}", "{color0}", 'NONE', 'NONE', 'NONE' ]
